          ...
          <div className="grid md:grid-cols-2 gap-8 items-center p-8 md:p-12">
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                <button className="px-8 py-3 bg-red-900 text-white rounded-full hover:bg-red-800 transition font-semibold">
                  PEÇA AGORA
                </button>
                <button className="px-8 py-3 bg-white text-red-900 border-2 border-red-900 rounded-full hover:bg-red-900 hover:text-white transition font-semibold">
                  RESERVAR
                </button>
              </div>
            </div>
            <div className="relative">
              <img 
                src="https://images.unsplash.com/photo-1603048588665-791ca8aea617?w=600&h=400&fit=crop" 
                alt="Carnes Premium"
